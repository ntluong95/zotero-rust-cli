...
var years = {}; var journals = {};
items.forEach(i => {
  var y = (i.getField('date') || '').substring(0,4); if (y) years[y] = (years[y]||0) + 1;
  var j = i.getField('publicationTitle') || ''; if (j) journals[j] = (journals[j]||0) + 1;
});
return {total: total, withPDF: withPDF, noPDF: total - withPDF, byYear: years,
